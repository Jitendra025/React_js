...
class Modal extends Component {
    ...
    shouldComponentUpdate(nextProps, nextState){
        return nextProps.show!==this.props.show; // Alreayd went through in previous chapter.. this is one of the class compoent life cycle method. If this method return true then only allow
                                                 ...
                                                 // die to change in some other components. This improves the performance of react.
    }
    componentWillUpdate() {
